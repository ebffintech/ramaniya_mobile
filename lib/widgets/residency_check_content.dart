...
class ResidencyCheckContent extends StatelessWidget {
  const ResidencyCheckContent({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        _ResidencyOptionCard(
          ...
          subtitle: 'Self-invest in mutual funds with PAN + Aadhaar KYC',
          onTap: () {},
        ),
        const SizedBox(height: 12),
        _ResidencyOptionCard(
...
class ResidencyCheckTopBar extends StatelessWidget {
  const ResidencyCheckTopBar({super.key});
...
class _ResidencyOptionCard extends StatelessWidget {
  const _ResidencyOptionCard({
    required this.icon,
    required this.iconHasBackground,
    required this.title,
